...
const file_shortener_proto_rawDesc = "" +
	...
	"\rRegisterClick\x12'.shortener_service.RegisterClickRequest\x1a(.shortener_service.RegisterClickResponse\"\x00B*Z(github.com/Aniketyadav44/s7r/api-gatewayb\x06proto3"
